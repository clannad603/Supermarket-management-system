package com.huangrui.hr_smms.utils;

import com.huangrui.hr_smms.dos.UpcInform;
...
public class BarcodeUtils {
    ...
    public static File generateFile(String msg, String path) {
        String path_prefix = "D:\\Users\\huangrui\\IdeaProjects\\hr_smms\\src\\main\\resources\\static\\img\\upc\\";
        File file = new File(path_prefix+path);
    ...
    public static void main(String[] args) {
        UpcInform upcInform = new UpcInform();
        for (int i = 1; i < 22; i++) {
            upcInform.setId(String.valueOf(i));
            String path = upcInform.getId()+".png";
            generateFile(upcInform.getId(), path);
        }
    }
}
